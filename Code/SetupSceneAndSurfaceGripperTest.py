...
def create_surfaceGripper_actionGraph(
    graph_path, grip_position_path, parent_rigidBody_path
):
...
def setup_scene():
    ...
    create_surfaceGripper_actionGraph(
        "/World/cube1/SurfaceGripperActionGraph",
        "/World/cube1/SurfaceGripperActionGraph/SurfaceGripperOffset",
        "/World/cube1",
    )
    create_xform(
        "/World/cube1/SurfaceGripperActionGraph/SurfaceGripperOffset",
