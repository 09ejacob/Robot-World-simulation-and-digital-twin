...
BOTTLEGRIPPER_JOINT_PATH_RIGHT = f"{JOINTS_PATH}/PrismaticJointGripperRight"
BOTTLEGRIPPER_JOINT_PATH_LEFT = f"{JOINTS_PATH}/PrismaticJointGripperLeft"
...
# Camera resolutions/frequency
CAMERA_RESOLUTIONS = {
    BASE_CAMERA_PATH: (720, 480),
    BOX_CAMERA_1: (720, 480),
    BOX_CAMERA_2: (720, 480),
    OVERVIEW_CAMERA: (720, 480),
}
CAMERA_FREQUENCIES = 5
...
# Bottlegripper configuration
BOTTLEGRIPPER_OPEN = 0.01
BOTTLEGRIPPER_CLOSE = -0.05
BOTTLEGRIPPER_IDLE = 0
